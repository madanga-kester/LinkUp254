...
namespace LinkUp254.Migrations
{
    ...
    [Migration("20260502105140_AddOrganizerFollowAndRatingTables")]
    partial class AddOrganizerFollowAndRatingTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkUp254.Features.Events.models.TicketTransaction", b =>
                {
                    ...
                    b.Property<DateTime?>("MpesaTransactionDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LinkUp254.Features.Events.models.TicketTransactionRefund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TicketTransactionRefund");
                });
            ...
            modelBuilder.Entity("LinkUp254.Features.Organizers.Models.Follow", b =>
                {
                    ...
                    b.HasKey("FollowerId", "OrganizerId");
            ...
            modelBuilder.Entity("LinkUp254.Features.Organizers.Models.OrganizerRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LinkUp254.Features.Shared.Newsletter.Models.NewsletterSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LinkUp254.Features.Events.models.TicketTransactionRefund", b =>
                {
                    b.HasOne("LinkUp254.Features.Events.models.TicketTransaction", "Transaction")
                        .WithMany("Refunds")
            ...
            modelBuilder.Entity("LinkUp254.Features.Organizers.Models.Follow", b =>
                {
                    b.HasOne("LinkUp254.Features.Shared.User", "Follower")
                        .WithMany()
